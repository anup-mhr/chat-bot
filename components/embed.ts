(async () => {
  ...
  async function loadMascotColor(): Promise<any> {
    let org: string;
    let loc: string | null;
    let reg: string | null;
  ...
  async function loadBot(): Promise<boolean> {
  ...
  function getLinkHistory(): string {
  ...
  const cookie = {
    ...
    isCookieExists: function (name: string): boolean {
